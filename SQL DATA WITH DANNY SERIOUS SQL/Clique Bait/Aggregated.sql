...
group by page_name),
cte9 as (
select cte3.page_name as page_name,cte3.count_of_views as count_of_views,cte3.count_of_add as count_of_add,cte8.count_of_purchase as count_of_purchase
from cte8 
join cte3 on cte3.page_name=cte8.page_name)
select page_name,count_of_views,count_of_add,(count_of_add-count_of_purchase) as count_of_abonded,count_of_purchase
from cte9
order by page_name
